        ...
        <div className="mt-[84px]">
            ...
            <div className="relative">
                ...
                <div className="w-full flex flex-col xl:flex-row">
                    {/* main column */}
                    <div className="w-full xl:w-3/4 z-20 py-16">
                        <div className="mx-auto my-auto flex flex-col lg:flex-row gap-10 items-start justify-center w-10/12 2xl:w-8/12">
                            <Image
                            ...
                            <div className="flex flex-col gap-5 text-sm">
                                ...
                                <div className="flex flex-wrap gap-3 justify-start items-center">
                                    <button className="h-9 px-5 py-2 shadow rounded-full font-semibold flex gap-1 items-center justify-center bg-primary text-neutral-900 text-base hover:bg-primary/80">
                                    ...
                                    <AddToListButton
                                        ...
                                        btnStyle="px-5 text-base"
                                        btnWidth="w-44"
                                    />
                                </div>
                                <div>
                                    <p
                                        className="line-clamp-3 leading-relaxed text-sm"
                                        id="synopsis-container"
                                    >
                                        {animeData.synopsis}
                                    </p>
                                    <ViewMoreLessBtn styles="text-xs font-semibold" />
                                </div>
                                {animeData.streaming.length > 0 && (
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-3 px-4 font-medium">
                    ...
                    {/* side column */}
                    <div className="w-full xl:w-[calc(25%-30px)] flex flex-col justify-center gap-3 text-sm px-7 py-16 bg-white/5 backdrop-blur-xl">
                        <div>
                        ...
                        <div className="flex items-center gap-2 flex-wrap border-y-[0.5px] border-y-white/30 py-3">
                            ...
                            {animeData.genres.map((genre: { name: string }) => (
                                <div
                                    key={genre.name}
                                    className="py-1 px-2 border border-white/30 rounded-3xl text-xs"
                                >
                                    {genre.name}
                                </div>
                            ))}
            ...
            <div className="w-full flex flex-col xl:flex-row mt-10 px-4 md:px-6 3xl:px-2">
                <div className="w-full xl:w-3/4">
                    {/* characters section */}
                    {characters && (
                        <div id="characters" className="md:px-4">
